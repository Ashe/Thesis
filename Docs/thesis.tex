...
\begin{itemize}
  \item \textbf{States:} represented by the tic-tac-toe \emph{GameState} class.
  \item \textbf{Actions:} locations of marks, represented by a pair of integers (the \emph{sf::Vector2i} class).
  \item \textbf{Costs:} represented by an integer value that acts as a penalty for illogical moves.
