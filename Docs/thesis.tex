...
\subsubsection{Software development methodology}
\label{subsubsec:softwareDevelopmentMethodology}
...
\subsubsection{Designing the process of investigation}
\label{subsubsec:designingInvestigation process}
...
\begin{table}[!h]
  ...
  \begin{tabular}{ | m{2.5cm} | m{4cm} | m{6cm} |}
    ...
    \emph{Heuristic} function & Determine an order in which \emph{GameStates} are explored & Don't guide it (by using Dijkstra's algorithm) or try different ways of estimating the \emph{Cost} of satisfying the goal \\ \hline
