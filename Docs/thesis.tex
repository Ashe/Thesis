...
The second requirement in section \ref{subsubsec:requirements} is to build a sample video game for the AI to play. Figure \ref{fig:strategyGameUML} shows \emph{TODO: Explain figure}
