...
\begin{itemize}
  ...
  \item \textbf{Weighing function:} Each element of \emph{Cost} is found through comparison of \emph{GameStates}. Constant arbitrary values are used to create the penalties; for example, 10 points are added to the `enemies remaining' penalty total. Since ending the turn doesn't require or change anything, ending the turn isn't penalised. 
\end{itemize}
